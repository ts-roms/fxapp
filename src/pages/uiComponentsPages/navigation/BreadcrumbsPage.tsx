...
import {
  Breadcrumb,
  BreadcrumbItem,
} from '@app/components/common/Breadcrumb/Breadcrumb';
      ...
      <Col>
        <S.Card title={t('breadcrumbs.basic')}>
          <Breadcrumb>
            ...
            <BreadcrumbItem href={pathname}>
              {t('breadcrumbs.applicationCenter')}
            </BreadcrumbItem>
            <BreadcrumbItem href={pathname}>
              {t('breadcrumbs.applicationList')}
            </BreadcrumbItem>
            <BreadcrumbItem href={pathname}>
              {t('breadcrumbs.application')}
            </BreadcrumbItem>
          </Breadcrumb>
        </S.Card>
        ...
        <S.Card title={t('breadcrumbs.withDropdown')}>
          <Breadcrumb>
            ...
            <BreadcrumbItem href={pathname}>
              {t('breadcrumbs.component')}
            </BreadcrumbItem>
            <BreadcrumbItem overlay={menu}>
              {t('breadcrumbs.general')}
            </BreadcrumbItem>
            <BreadcrumbItem href={pathname}>
              {t('breadcrumbs.button')}
            </BreadcrumbItem>
          </Breadcrumb>
        </S.Card>
      </Col>

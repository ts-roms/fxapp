...
@section('content')
    <form method="post" class="validate" autocomplete="off" action="{{ action('MemberController@update', $id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="member_no"
                                        value="{{ $member->member_no }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 auto-select" name="country_code"
                                        data-selected="{{ $member->country_code }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control auto-select" data-selected="{{ $member->gender }}"
                                        name="gender">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" name="photo"
                                        ...
                                        data-default-file="{{ profile_picture($member->photo) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 auto-select"
                                        data-selected="{{ $member->user->status }}" name="status">
                                        <option value="">{{ _lang('Select One') }}</option>

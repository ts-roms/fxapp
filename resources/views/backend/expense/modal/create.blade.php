<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('expenses.store') }}"
    ...
    <div class="row px-2">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="reference" value="{{ generate_reference('EXP', 6) }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control datetimepicker" name="expense_date"
                    value="{{ old('expense_date', now()) }}" required>
            </div>
        </div>

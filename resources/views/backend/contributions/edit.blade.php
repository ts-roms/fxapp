        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="panel-title">{{ 'Update Contribution Info' }}</div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                            value="{{ $contribution->capital_buildup }}" id="capital_buildup"
                                            name="capital_buildup" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                            value="{{ $contribution->emergency_funds }}" id="emergency_funds"
                                            name="emergency_funds" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                            value="{{ $contribution->mortuary_funds }}" id="mortuary_funds"
                                            name="mortuary_funds" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="control-label">{{ _lang('Notes') }}</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="{{ $contribution->notes }}"
                                            id="notes" name="notes">
                                    </div>
                                </div>
                                <div class="form-group">

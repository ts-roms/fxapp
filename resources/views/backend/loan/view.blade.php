            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ action('LoanController@edit', $loan['id']) }}">{{ _lang('Edit') }}</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                        ...
                        <div class="tab-pane active" id="loan_details">
                            @if ($loan->status == 0)
                                <div class="alert alert-warning mt-4">
                                    <span>
                                        {{ _lang('Add Loan ID, Release Date, First Payment Date and Guarantor before approving loan request') }}
                                    </span>
                                </div>
                            @endif
                                            ...
                                            <tbody>
                                                @foreach ($guarantors as $guarantor)
                                                    <tr data-id="row_{{ $guarantor->id }}">
                                                        ...
                                                        <td class='amount'>
                                                            {{ decimalPlace($guarantor->amount, currency($loan->currency->name)) }}
                                                        </td>
                                                            ...
                                                            <span class="dropdown">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="{{ action('GuarantorController@edit', $guarantor['id']) }}"
                                                                            data-title="{{ _lang('Update Guarantor') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <b>{{ decimalPlace($guarantors->sum('amount'), currency($loan->currency->name)) }}</b>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
